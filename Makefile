...
test:
	...
	uv run ./convert.py -k loc_data.csv celltower_data/merged_uk_data.csv balltree real_output.csv
	uv run ./train.py --optimize real_output.csv -i 5 loc_data.csv grav_model.json TRIPLEPOWER
